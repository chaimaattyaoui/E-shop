...
public class AdminOrderServiceImpl implements AdminOrderService {
    ...
    public AnalyticsResponce calculateAnalytics() {
        ...
        return new AnalyticsResponce(placed, shipped, delivered, currentMonthOrders, previousMonthOrders, currentMonthEarnings, previousMonthEarnings);
