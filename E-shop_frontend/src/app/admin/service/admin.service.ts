...
/*
    ...
    return this.http.get(`${BASIC_URL}/api/admin/product/${productId}`,  {
      ...
      getProductDetailById(productId:number): Observable<any> {
         return this.http.get(`${BASIC_URL}/api/admin/product/detail/${productId}`,  {
          headers: this.createAuthorizationHeader()
        });
  ...
  return this.http.delete(`${BASIC_URL}/api/admin/coupons/${id}`,{
    headers: this.createAuthorizationHeader()
  });
}

getAllProductsWithRatings(): Observable<any> {
    return this.http.get(`${BASIC_URL}/api/admin/products-with-ratings`, {
      headers: this.createAuthorizationHeader()
    });
  }
